...
BOT_TOKEN = environ.get('BOT_TOKEN', "8383572251:AAFAwz1bIgpTTnPf_M1iOcDt2yhtVEHjZFk")    # Bot token from @BotFather
...
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://envs.sh/o_V.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://envs.sh/o_V.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/o_V.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://envs.sh/lZ5.jpg')).split()  # Fsub pic
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002971582812'))  # Premium logs channel id
...
MSG_ALRT = environ.get('MSG_ALRT', 'Bot By ➻ @MissProviderBhaskar') # Alert message for users
